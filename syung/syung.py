...
def database_check():
    conn= pymysql.connect(host='192.168.35.138', user='localhost', password='', db='user_info1', charset='utf8')
    curs = conn.cursor()
...
def database_update(ID,z):
    conn= pymysql.connect(host='192.168.35.138', user='localhost', password='', db='codemonster', charset='utf8')
    curs = conn.cursor()
